(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-plain-slider"] = factory();
	else
		root["vue-plain-slider"] = factory();
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"E://GitRepo-Songyazhao//vue-plain-slider//node_modules//.cache//vue-loader","cacheIdentifier":"041ec322-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Slider/index.vue?vue&type=template&id=32d2fbba
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"slider",staticClass:"slider",class:[_vm.direction, {'dragging': _vm.dragging}],on:{"touchstart":_vm._onTouchStart,"mousedown":_vm._onTouchStart,"wheel":_vm._onWheel}},[_c('div',{ref:"sliderWrap",staticClass:"slider-wrap",style:({
			'transform' : 'translate3d(' + _vm.translateX + 'px,' + _vm.translateY + 'px, 0)',
			'transition-duration': _vm.transitionDuration + 'ms'
		}),on:{"transitionend":_vm._onTransitionEnd}},[_vm._t("default")],2),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.paginationVisible),expression:"paginationVisible"}],staticClass:"slider-pagination"},_vm._l((_vm.slideEls),function(slide,index){return _c('span',{key:index,staticClass:"slider-pagination-bullet",class:{'active': index+1===_vm.currentPage},on:{"click":function($event){_vm.paginationClickable && _vm.setPage(index+1)}}})}))])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Slider/index.vue?vue&type=template&id=32d2fbba
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Slider/index.vue?vue&type=script&lang=js
...
/* harmony default export */ var Slidervue_type_script_lang_js = ({
  ...
  mounted: function mounted() {
    ...
    this.$watch('currentPage', function (val) {
      return _this.$emit('update:curPage', val);
    });
    this.$watch('asyncData', this._sliderInit, {
      deep: true,
      immediate: true
    });
  },
  ...
  methods: {
    _sliderInit: function _sliderInit(newAsyncData, oldAsyncData) {
      var _this2 = this;

      if (!newAsyncData || Array.isArray(newAsyncData) && newAsyncData.length > 0) {
        if (this.loop) {
          this.cloneEl.forEach(function (el) {
            return el.remove();
          });
          this.$nextTick(function () {
            _this2._createLoop();

            _this2.setPage(_this2.currentPage, true);
          });
        } else {
        ...
        this.slideEls = [].map.call(this.$refs.sliderWrap.children, function (el) {
          return el;
        });
      }
    },
    ...
    setPage: function setPage(page, noAnimation) {
      ...
      if (this.loop) {
        ...
        setTimeout(function () {
          _this3._setTranslate(_this3._getTranslateOfPage(page));

          if (noAnimation) return;

          _this3._onTransitionStart();
        }, 0);
      } else {
    ...
    _createLoop: function _createLoop() {
      var propName = this.isHorizontal() ? 'clientWidth' : 'clientHeight';
      var sliderWrapEl = this.$refs.sliderWrap;
      var duplicateFirstChild = sliderWrapEl.firstElementChild.cloneNode(true);
      var duplicateLastChild = sliderWrapEl.lastElementChild.cloneNode(true);
...
// CONCATENATED MODULE: ./src/components/Slider/index.vue?vue&type=script&lang=js
 /* harmony default export */ var components_Slidervue_type_script_lang_js = (Slidervue_type_script_lang_js); 
// EXTERNAL MODULE: ./src/components/Slider/index.vue?vue&type=style&index=0&lang=less
var Slidervue_type_style_index_0_lang_less = __webpack_require__("vLy8");
...
// CONCATENATED MODULE: ./src/components/Slider/index.vue
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6GeG");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_less__WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_index_js_ref_10_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_10_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_less__WEBPACK_IMPORTED_MODULE_0___default.a); 
...
//# sourceMappingURL=vue-plain-slider.umd.js.map