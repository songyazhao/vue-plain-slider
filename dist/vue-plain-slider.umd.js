...
// CONCATENATED MODULE: ./src/components/Slider/index.vue?vue&type=template&id=551e5f92
  ...
  mounted: function mounted() {
    ...
    if (this.loop) {
      this.$nextTick(function () {
        ...
        _this.setPage(_this.currentPage, true);
      });
    } else {
